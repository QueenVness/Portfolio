...
ANOVA<-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet = "Tracker")
BROADREACH<-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet = "Tracker")
GUIDEHOUSE<-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet = "Tracker")
GETF_NEXTMILE<-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet = "Tracker")
EQUIP<-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet = "Tracker") #phase out after Dec 2021
ADAPT_RTC <-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet = "RTC") %>% 
...
ADAPT_Aurum <-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet = "Aurum")

ADAPT_FPD <-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet="FPD")

ADAPT_Genesis <-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet="Genesis")

ADAPT_HE2RO <-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet="HE2RO")

ADAPT_IHPS <-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet="IHPS")

ADAPT_NICD <-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet="NICD")

ADAPT_Qode <-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet="Qode")

ADAPT_ReAction <-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet="ReAction!")

ADAPT_Stellenbosch <-read_sheet(as_sheets_id('ADD GOOGLE SHEET ID'), sheet="Stellenbosch")
